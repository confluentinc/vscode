...
export const TEST_DIRECT_CONNECTION_SSL: Connection = ConnectionFromJSON({
  api_version: "gateway/v1",
  kind: "Connection",
  id: TEST_DIRECT_CONNECTION_ID,
  metadata: {
...
/** Fake spec augmented with `formConnectionType` for test purposes. */
export const TEST_DIRECT_CONNECTION_FORM_SSL: CustomConnectionSpec = {
  ...ConnectionSpecFromJSON(TEST_DIRECT_CONNECTION_SSL.spec),
  id: TEST_DIRECT_CONNECTION_ID, // enforced ConnectionId type
  formConnectionType: "Apache Kafka",
};
