 ...
 */
export function instanceOfJSONPatchRequestMoveCopy(value: object): value is JSONPatchRequestMoveCopy {
...
export function JSONPatchRequestMoveCopyToJSONTyped(value?: JSONPatchRequestMoveCopy | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
