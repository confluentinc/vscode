 ...
 */
export function instanceOfEnvScopedObjectReference(value: object): value is EnvScopedObjectReference {
...
export function EnvScopedObjectReferenceFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnvScopedObjectReference {
    if (json == null) {
        return json;
    }
    return {
...
export function EnvScopedObjectReferenceToJSONTyped(value?: Omit<EnvScopedObjectReference, 'environment'|'related'|'resource_name'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
