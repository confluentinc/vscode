...
export function WsV1WorkspaceMetadataFromJSONTyped(
  json: any,
  ignoreDiscriminator: boolean,
): WsV1WorkspaceMetadata {
  if (json == null) {
    return json;
  }
  return {
...
export function WsV1WorkspaceMetadataToJSONTyped(
  value?: Omit<
    WsV1WorkspaceMetadata,
    "uid" | "resource_version" | "created_by" | "created_at" | "updated_at"
  > | null,
