...
export function GlobalObjectReferenceFromJSONTyped(json: any, ignoreDiscriminator: boolean): GlobalObjectReference {
    if (json == null) {
        return json;
    }
    return {
...
export function GlobalObjectReferenceToJSONTyped(value?: Omit<GlobalObjectReference, 'related'|'resource_name'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
