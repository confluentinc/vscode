...
export function ObjectMetaToJSONTyped(value?: Omit<ObjectMeta, 'self'|'uid'|'resource_version'|'created_by'|'created_at'|'updated_at'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
