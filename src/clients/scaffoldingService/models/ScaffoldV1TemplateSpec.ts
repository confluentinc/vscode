...
export function ScaffoldV1TemplateSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScaffoldV1TemplateSpec {
    if (json == null) {
        return json;
    }
    return {
        ...
        'options': json['options'] == null ? undefined : (mapValues(json['options'], ScaffoldV1TemplateOptionFromJSON)),
        'template_collection': json['template_collection'] == null ? undefined : GlobalObjectReferenceFromJSON(json['template_collection']),
    };
}
...
export function ScaffoldV1TemplateSpecToJSONTyped(value?: ScaffoldV1TemplateSpec | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'tags': value['tags'],
        'options': value['options'] == null ? undefined : (mapValues(value['options'], ScaffoldV1TemplateOptionToJSON)),
