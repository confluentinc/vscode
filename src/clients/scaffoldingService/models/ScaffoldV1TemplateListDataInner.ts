 ...
 */
export function instanceOfScaffoldV1TemplateListDataInner(value: object): value is ScaffoldV1TemplateListDataInner {
    if (!('metadata' in value) || value['metadata'] === undefined) return false;
    if (!('spec' in value) || value['spec'] === undefined) return false;
    return true;
}

export function ScaffoldV1TemplateListDataInnerFromJSON(json: any): ScaffoldV1TemplateListDataInner {
    return ScaffoldV1TemplateListDataInnerFromJSONTyped(json, false);
}

export function ScaffoldV1TemplateListDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScaffoldV1TemplateListDataInner {
    if (json == null) {
        return json;
    }
    return {
...
export function ScaffoldV1TemplateListDataInnerToJSONTyped(value?: Omit<ScaffoldV1TemplateListDataInner, 'api_version'|'kind'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
