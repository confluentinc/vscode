 ...
 */
export function instanceOfScaffoldV1TemplateCollectionListDataInner(value: object): value is ScaffoldV1TemplateCollectionListDataInner {
    if (!('metadata' in value) || value['metadata'] === undefined) return false;
    if (!('spec' in value) || value['spec'] === undefined) return false;
    return true;
}

export function ScaffoldV1TemplateCollectionListDataInnerFromJSON(json: any): ScaffoldV1TemplateCollectionListDataInner {
    return ScaffoldV1TemplateCollectionListDataInnerFromJSONTyped(json, false);
}

export function ScaffoldV1TemplateCollectionListDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScaffoldV1TemplateCollectionListDataInner {
    if (json == null) {
        return json;
    }
    return {
...
export function ScaffoldV1TemplateCollectionListDataInnerToJSON(json: any): ScaffoldV1TemplateCollectionListDataInner {
    return ScaffoldV1TemplateCollectionListDataInnerToJSONTyped(json, false);
}

export function ScaffoldV1TemplateCollectionListDataInnerToJSONTyped(value?: Omit<ScaffoldV1TemplateCollectionListDataInner, 'api_version'|'kind'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
