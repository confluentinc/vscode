...
export function ScaffoldV1TemplateListFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScaffoldV1TemplateList {
    if (json == null) {
        return json;
    }
    return {
...
export function ScaffoldV1TemplateListToJSONTyped(value?: Omit<ScaffoldV1TemplateList, 'api_version'|'kind'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
