 ...
 */
export function instanceOfScaffoldV1TemplateCollectionList(value: object): value is ScaffoldV1TemplateCollectionList {
...
export function ScaffoldV1TemplateCollectionListFromJSON(json: any): ScaffoldV1TemplateCollectionList {
    return ScaffoldV1TemplateCollectionListFromJSONTyped(json, false);
}

export function ScaffoldV1TemplateCollectionListFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScaffoldV1TemplateCollectionList {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': (new Set((json['data'] as Array<any>).map(ScaffoldV1TemplateCollectionListDataInnerFromJSON))),
    };
}

export function ScaffoldV1TemplateCollectionListToJSON(json: any): ScaffoldV1TemplateCollectionList {
    return ScaffoldV1TemplateCollectionListToJSONTyped(json, false);
}

export function ScaffoldV1TemplateCollectionListToJSONTyped(value?: Omit<ScaffoldV1TemplateCollectionList, 'api_version'|'kind'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': (Array.from(value['data'] as Set<any>).map(ScaffoldV1TemplateCollectionListDataInnerToJSON)),
    };
}
