...
* @enum {string}
*/
export enum ScaffoldV1TemplateCollectionApiVersionEnum {
...
* @enum {string}
*/
export enum ScaffoldV1TemplateCollectionKindEnum {
 ...
 */
export function instanceOfScaffoldV1TemplateCollection(value: object): value is ScaffoldV1TemplateCollection {
    return true;
}
...
export function ScaffoldV1TemplateCollectionFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScaffoldV1TemplateCollection {
    if (json == null) {
        return json;
    }
    return {
...
export function ScaffoldV1TemplateCollectionToJSONTyped(value?: Omit<ScaffoldV1TemplateCollection, 'api_version'|'kind'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
