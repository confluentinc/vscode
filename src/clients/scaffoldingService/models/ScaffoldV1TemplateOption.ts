 ...
 */
export function instanceOfScaffoldV1TemplateOption(value: object): value is ScaffoldV1TemplateOption {
...
export function ScaffoldV1TemplateOptionFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScaffoldV1TemplateOption {
    if (json == null) {
        return json;
    }
    return {
        ...
        'pattern_description': json['pattern_description'] == null ? undefined : json['pattern_description'],
...
export function ScaffoldV1TemplateOptionToJSONTyped(value?: ScaffoldV1TemplateOption | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
