...
* @enum {string}
*/
export enum ScaffoldV1TemplateApiVersionEnum {
...
* @enum {string}
*/
export enum ScaffoldV1TemplateKindEnum {
    Template = 'Template'
}
...
export function ScaffoldV1TemplateFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScaffoldV1Template {
    if (json == null) {
        return json;
    }
    return {
...
export function ScaffoldV1TemplateToJSONTyped(value?: Omit<ScaffoldV1Template, 'api_version'|'kind'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
