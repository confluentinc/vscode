...
export class TemplatesScaffoldV1Api extends runtime.BaseAPI {
     ...
     * Apply a Template
     */
    async applyScaffoldV1TemplateRaw(requestParameters: ApplyScaffoldV1TemplateOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Blob>> {
        ...
        const response = await this.request({
            path: `/scaffold/v1/template-collections/{template-collection-name}/templates/{name}/apply`.replace(`{${"template-collection-name"}}`, encodeURIComponent(String(requestParameters['template_collection_name']))).replace(`{${"name"}}`, encodeURIComponent(String(requestParameters['name']))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: ApplyScaffoldV1TemplateRequestToJSON(requestParameters['ApplyScaffoldV1TemplateRequest']),
        }, initOverrides);
     ...
     * Apply a Template
     */
    async applyScaffoldV1Template(requestParameters: ApplyScaffoldV1TemplateOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Blob> {
     ...
     * Read a Template
     */
    async getScaffoldV1TemplateRaw(requestParameters: GetScaffoldV1TemplateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetScaffoldV1Template200Response>> {
        if (requestParameters['template_collection_name'] == null) {
            throw new runtime.RequiredError(
                'template_collection_name',
        ...
        const response = await this.request({
            path: `/scaffold/v1/template-collections/{template-collection-name}/templates/{name}`.replace(`{${"template-collection-name"}}`, encodeURIComponent(String(requestParameters['template_collection_name']))).replace(`{${"name"}}`, encodeURIComponent(String(requestParameters['name']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => GetScaffoldV1Template200ResponseFromJSON(jsonValue));
    }
     ...
     * Read a Template
     */
    async getScaffoldV1Template(requestParameters: GetScaffoldV1TemplateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetScaffoldV1Template200Response> {
     ...
     * List of Templates
     */
    async listScaffoldV1TemplatesRaw(requestParameters: ListScaffoldV1TemplatesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ScaffoldV1TemplateList>> {
        if (requestParameters['template_collection_name'] == null) {
            throw new runtime.RequiredError(
                'template_collection_name',
        ...
        const response = await this.request({
            path: `/scaffold/v1/template-collections/{template-collection-name}/templates`.replace(`{${"template-collection-name"}}`, encodeURIComponent(String(requestParameters['template_collection_name']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ScaffoldV1TemplateListFromJSON(jsonValue));
    }
     ...
     * List of Templates
     */
    async listScaffoldV1Templates(requestParameters: ListScaffoldV1TemplatesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ScaffoldV1TemplateList> {
