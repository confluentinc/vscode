...
export class StatementsSqlV1Api extends runtime.BaseAPI {
     ...
     * Create a Statement
     */
    async createSqlv1StatementRaw(requestParameters: CreateSqlv1StatementOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateSqlv1Statement201Response>> {
        ...
        const response = await this.request({
            path: `/sql/v1/organizations/{organization_id}/environments/{environment_id}/statements`.replace(`{${"organization_id"}}`, encodeURIComponent(String(requestParameters['organization_id']))).replace(`{${"environment_id"}}`, encodeURIComponent(String(requestParameters['environment_id']))),
            method: 'POST',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => CreateSqlv1Statement201ResponseFromJSON(jsonValue));
    }
     ...
     * Create a Statement
     */
    async createSqlv1Statement(requestParameters: CreateSqlv1StatementOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateSqlv1Statement201Response> {
     ...
     * Delete a Statement
     */
    async deleteSqlv1StatementRaw(requestParameters: DeleteSqlv1StatementRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['organization_id'] == null) {
            throw new runtime.RequiredError(
                'organization_id',
        ...
        const response = await this.request({
            path: `/sql/v1/organizations/{organization_id}/environments/{environment_id}/statements/{statement_name}`.replace(`{${"organization_id"}}`, encodeURIComponent(String(requestParameters['organization_id']))).replace(`{${"environment_id"}}`, encodeURIComponent(String(requestParameters['environment_id']))).replace(`{${"statement_name"}}`, encodeURIComponent(String(requestParameters['statement_name']))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Delete a Statement
     */
    async deleteSqlv1Statement(requestParameters: DeleteSqlv1StatementRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
     ...
     * Read a Statement
     */
    async getSqlv1StatementRaw(requestParameters: GetSqlv1StatementRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetSqlv1Statement200Response>> {
        if (requestParameters['organization_id'] == null) {
            throw new runtime.RequiredError(
                'organization_id',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetSqlv1Statement200ResponseFromJSON(jsonValue));
    }
     ...
     * Read a Statement
     */
    async getSqlv1Statement(requestParameters: GetSqlv1StatementRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetSqlv1Statement200Response> {
     ...
     * List of Statements
     */
    async listSqlv1StatementsRaw(requestParameters: ListSqlv1StatementsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SqlV1StatementList>> {
        if (requestParameters['organization_id'] == null) {
            throw new runtime.RequiredError(
                'organization_id',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => SqlV1StatementListFromJSON(jsonValue));
    }
     ...
     * List of Statements
     */
    async listSqlv1Statements(requestParameters: ListSqlv1StatementsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SqlV1StatementList> {
     ...
     * Patch a Statement
     */
    async patchSqlv1StatementRaw(requestParameters: PatchSqlv1StatementRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateSqlv1Statement201Response>> {
        if (requestParameters['organization_id'] == null) {
            throw new runtime.RequiredError(
                'organization_id',
     ...
     * Patch a Statement
     */
    async patchSqlv1Statement(requestParameters: PatchSqlv1StatementRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateSqlv1Statement201Response> {
     ...
     * Update a Statement
     */
    async updateSqlv1StatementRaw(requestParameters: UpdateSqlv1StatementOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['organization_id'] == null) {
            throw new runtime.RequiredError(
                'organization_id',
     ...
     * Update a Statement
     */
    async updateSqlv1Statement(requestParameters: UpdateSqlv1StatementOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
