...
export class ConnectionsSqlV1Api extends runtime.BaseAPI {
     ...
     * Create a Connection
     */
    async createSqlv1ConnectionRaw(requestParameters: CreateSqlv1ConnectionOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateSqlv1Connection201Response>> {
        ...
        const response = await this.request({
            path: `/sql/v1/organizations/{organization_id}/environments/{environment_id}/connections`.replace(`{${"organization_id"}}`, encodeURIComponent(String(requestParameters['organization_id']))).replace(`{${"environment_id"}}`, encodeURIComponent(String(requestParameters['environment_id']))),
            method: 'POST',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => CreateSqlv1Connection201ResponseFromJSON(jsonValue));
    }
     ...
     * Create a Connection
     */
    async createSqlv1Connection(requestParameters: CreateSqlv1ConnectionOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateSqlv1Connection201Response> {
     ...
     * Delete a Connection
     */
    async deleteSqlv1ConnectionRaw(requestParameters: DeleteSqlv1ConnectionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['organization_id'] == null) {
            throw new runtime.RequiredError(
                'organization_id',
        ...
        const response = await this.request({
            path: `/sql/v1/organizations/{organization_id}/environments/{environment_id}/connections/{connection_name}`.replace(`{${"organization_id"}}`, encodeURIComponent(String(requestParameters['organization_id']))).replace(`{${"environment_id"}}`, encodeURIComponent(String(requestParameters['environment_id']))).replace(`{${"connection_name"}}`, encodeURIComponent(String(requestParameters['connection_name']))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Delete a Connection
     */
    async deleteSqlv1Connection(requestParameters: DeleteSqlv1ConnectionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
     ...
     * Read a Connection
     */
    async getSqlv1ConnectionRaw(requestParameters: GetSqlv1ConnectionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetSqlv1Connection200Response>> {
        if (requestParameters['organization_id'] == null) {
            throw new runtime.RequiredError(
                'organization_id',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetSqlv1Connection200ResponseFromJSON(jsonValue));
    }
     ...
     * Read a Connection
     */
    async getSqlv1Connection(requestParameters: GetSqlv1ConnectionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetSqlv1Connection200Response> {
     ...
     * List of Connections
     */
    async listSqlv1ConnectionsRaw(requestParameters: ListSqlv1ConnectionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SqlV1ConnectionList>> {
        if (requestParameters['organization_id'] == null) {
            throw new runtime.RequiredError(
                'organization_id',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => SqlV1ConnectionListFromJSON(jsonValue));
    }
     ...
     * List of Connections
     */
    async listSqlv1Connections(requestParameters: ListSqlv1ConnectionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SqlV1ConnectionList> {
     ...
     * Update a Connection
     */
    async updateSqlv1ConnectionRaw(requestParameters: UpdateSqlv1ConnectionOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['organization_id'] == null) {
            throw new runtime.RequiredError(
                'organization_id',
     ...
     * Update a Connection
     */
    async updateSqlv1Connection(requestParameters: UpdateSqlv1ConnectionOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
