 ...
 */
export function instanceOfSqlV1ConnectionListDataInner(value: object): value is SqlV1ConnectionListDataInner {
...
export function SqlV1ConnectionListDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): SqlV1ConnectionListDataInner {
    if (json == null) {
        return json;
    }
    return {
...
export function SqlV1ConnectionListDataInnerToJSONTyped(value?: Omit<SqlV1ConnectionListDataInner, 'api_version'|'kind'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
