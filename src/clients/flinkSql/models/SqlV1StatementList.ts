...
* @enum {string}
*/
export enum SqlV1StatementListApiVersionEnum {
    SqlV1 = 'sql/v1'
}
/**
* @export
* @enum {string}
*/
export enum SqlV1StatementListKindEnum {
...
export function SqlV1StatementListFromJSONTyped(json: any, ignoreDiscriminator: boolean): SqlV1StatementList {
    if (json == null) {
        return json;
    }
    return {
...
export function SqlV1StatementListToJSONTyped(value?: SqlV1StatementList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
