...
* @enum {string}
*/
export enum UpdateSqlv1StatementRequestApiVersionEnum {
    SqlV1 = 'sql/v1'
}
/**
* @export
* @enum {string}
*/
export enum UpdateSqlv1StatementRequestKindEnum {
    Statement = 'Statement'
}
 ...
 */
export function instanceOfUpdateSqlv1StatementRequest(value: object): value is UpdateSqlv1StatementRequest {
...
export function UpdateSqlv1StatementRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateSqlv1StatementRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateSqlv1StatementRequestToJSONTyped(value?: Omit<UpdateSqlv1StatementRequest, 'api_version'|'kind'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
