 ...
 */
export function instanceOfGetSqlv1Connection200Response(value: object): value is GetSqlv1Connection200Response {
...
export function GetSqlv1Connection200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetSqlv1Connection200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetSqlv1Connection200ResponseToJSONTyped(value?: Omit<GetSqlv1Connection200Response, 'api_version'|'kind'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
