...
export function SqlV1ConnectionSpecAuthDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): SqlV1ConnectionSpecAuthData {
    if (json == null) {
        return json;
    }
    switch (json['kind']) {
        case 'PlaintextProvider':
            return Object.assign({}, SqlV1PlaintextProviderFromJSONTyped(json, true), { kind: 'PlaintextProvider' } as const);
        default:
            throw new Error(`No variant of SqlV1ConnectionSpecAuthData exists with 'kind=${json['kind']}'`);
    }
}
...
export function SqlV1ConnectionSpecAuthDataToJSONTyped(value?: SqlV1ConnectionSpecAuthData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['kind']) {
        case 'PlaintextProvider':
            return Object.assign({}, SqlV1PlaintextProviderToJSON(value), { kind: 'PlaintextProvider' } as const);
        default:
            throw new Error(`No variant of SqlV1ConnectionSpecAuthData exists with 'kind=${value['kind']}'`);
    }
