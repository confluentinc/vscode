...
export function SqlV1StatementTraitsFromJSONTyped(json: any, ignoreDiscriminator: boolean): SqlV1StatementTraits {
    if (json == null) {
        return json;
    }
    return {
        ...
        'connection_refs': json['connection_refs'] == null ? undefined : json['connection_refs'],
    };
}
...
export function SqlV1StatementTraitsToJSONTyped(value?: SqlV1StatementTraits | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'connection_refs': value['connection_refs'],
    };
}
