...
export function StatementObjectMetaFromJSONTyped(json: any, ignoreDiscriminator: boolean): StatementObjectMeta {
    if (json == null) {
        return json;
    }
    return {
...
export function StatementObjectMetaToJSONTyped(value?: StatementObjectMeta | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
