...
* @enum {string}
*/
export enum SqlV1StatementExceptionListApiVersionEnum {
    SqlV1 = 'sql/v1'
}
/**
* @export
* @enum {string}
*/
export enum SqlV1StatementExceptionListKindEnum {
 ...
 */
export function instanceOfSqlV1StatementExceptionList(value: object): value is SqlV1StatementExceptionList {
...
export function SqlV1StatementExceptionListFromJSONTyped(json: any, ignoreDiscriminator: boolean): SqlV1StatementExceptionList {
    if (json == null) {
        return json;
    }
    return {
...
export function SqlV1StatementExceptionListToJSONTyped(value?: SqlV1StatementExceptionList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
