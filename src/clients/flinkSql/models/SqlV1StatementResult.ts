...
export function SqlV1StatementResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): SqlV1StatementResult {
    if (json == null) {
        return json;
    }
    return {
        ...
        'results': json['results'] == null ? undefined : SqlV1StatementResultResultsFromJSON(json['results']),
    };
}
...
export function SqlV1StatementResultToJSONTyped(value?: SqlV1StatementResult | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
