...
export function SqlV1StatementExceptionFromJSONTyped(json: any, ignoreDiscriminator: boolean): SqlV1StatementException {
    if (json == null) {
        return json;
    }
    return {
...
export function SqlV1StatementExceptionToJSONTyped(value?: Omit<SqlV1StatementException, 'name'|'message'|'timestamp'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
