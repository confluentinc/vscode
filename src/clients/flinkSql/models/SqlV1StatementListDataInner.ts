 ...
 */
export function instanceOfSqlV1StatementListDataInner(value: object): value is SqlV1StatementListDataInner {
...
export function SqlV1StatementListDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): SqlV1StatementListDataInner {
    if (json == null) {
        return json;
    }
    return {
...
export function SqlV1StatementListDataInnerToJSONTyped(value?: Omit<SqlV1StatementListDataInner, 'api_version'|'kind'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
