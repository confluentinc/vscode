...
export function SqlV1ConnectionFromJSONTyped(json: any, ignoreDiscriminator: boolean): SqlV1Connection {
    if (json == null) {
        return json;
    }
    return {
...
export function SqlV1ConnectionToJSONTyped(value?: Omit<SqlV1Connection, 'api_version'|'kind'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
