 ...
 */
export function instanceOfCreateSqlv1ConnectionRequest(value: object): value is CreateSqlv1ConnectionRequest {
...
export function CreateSqlv1ConnectionRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateSqlv1ConnectionRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateSqlv1ConnectionRequestToJSONTyped(value?: Omit<CreateSqlv1ConnectionRequest, 'api_version'|'kind'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
