 ...
 */
export function instanceOfGetSqlv1Statement200Response(value: object): value is GetSqlv1Statement200Response {
...
export function GetSqlv1Statement200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetSqlv1Statement200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetSqlv1Statement200ResponseToJSONTyped(value?: Omit<GetSqlv1Statement200Response, 'api_version'|'kind'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
