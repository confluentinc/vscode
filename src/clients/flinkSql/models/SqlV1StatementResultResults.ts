 ...
 */
export function instanceOfSqlV1StatementResultResults(value: object): value is SqlV1StatementResultResults {
    return true;
}
...
export function SqlV1StatementResultResultsFromJSONTyped(json: any, ignoreDiscriminator: boolean): SqlV1StatementResultResults {
    if (json == null) {
        return json;
    }
    return {
...
export function SqlV1StatementResultResultsToJSONTyped(value?: SqlV1StatementResultResults | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
