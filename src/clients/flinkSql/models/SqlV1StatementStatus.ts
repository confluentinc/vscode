...
export function SqlV1StatementStatusFromJSONTyped(
  ...
  return {
    ...
    state_limit_status:
      json["state_limit_status"] == null
        ? undefined
        : SqlV1StateLimitStatusFromJSON(json["state_limit_status"]),
    ...
    affected_resource:
      json["affected_resource"] == null
        ? undefined
        : SqlV1StatementStatusAffectedResourceFromJSON(json["affected_resource"]),
  };
}
...
export function SqlV1StatementStatusToJSONTyped(
  value?: Omit<
    SqlV1StatementStatus,
    "phase" | "detail" | "warnings" | "network_kind" | "latest_offsets" | "latest_offsets_timestamp"
  > | null,
