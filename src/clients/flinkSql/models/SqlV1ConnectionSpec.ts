...
export function SqlV1ConnectionSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): SqlV1ConnectionSpec {
    if (json == null) {
        return json;
    }
    return {
        ...
        'auth_data': json['auth_data'] == null ? undefined : SqlV1ConnectionSpecAuthDataFromJSON(json['auth_data']),
    };
}
...
export function SqlV1ConnectionSpecToJSONTyped(value?: SqlV1ConnectionSpec | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
