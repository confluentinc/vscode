...
export function DataTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): DataType {
    ...
    return {
        ...
        'fields': json['fields'] == null ? undefined : ((json['fields'] as Array<any>).map(RowFieldTypeFromJSON)),
        'resolution': json['resolution'] == null ? undefined : json['resolution'],
        'fractional_precision': json['fractional_precision'] == null ? undefined : json['fractional_precision'],
        'class_name': json['class_name'] == null ? undefined : json['class_name'],
    };
}
...
export function DataTypeToJSONTyped(value?: DataType | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'fields': value['fields'] == null ? undefined : ((value['fields'] as Array<any>).map(RowFieldTypeToJSON)),
