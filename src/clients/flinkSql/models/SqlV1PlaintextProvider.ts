...
export function SqlV1PlaintextProviderFromJSONTyped(json: any, ignoreDiscriminator: boolean): SqlV1PlaintextProvider {
    if (json == null) {
        return json;
    }
    return {
...
export function SqlV1PlaintextProviderToJSONTyped(value?: SqlV1PlaintextProvider | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
