 ...
 */
export function instanceOfCreateSqlv1StatementRequest(value: object): value is CreateSqlv1StatementRequest {
...
export function CreateSqlv1StatementRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateSqlv1StatementRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateSqlv1StatementRequestToJSONTyped(value?: Omit<CreateSqlv1StatementRequest, 'api_version'|'kind'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
