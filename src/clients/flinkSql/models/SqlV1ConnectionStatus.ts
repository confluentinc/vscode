...
export function SqlV1ConnectionStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): SqlV1ConnectionStatus {
    if (json == null) {
        return json;
    }
    return {
...
export function SqlV1ConnectionStatusToJSONTyped(value?: Omit<SqlV1ConnectionStatus, 'phase'|'detail'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
