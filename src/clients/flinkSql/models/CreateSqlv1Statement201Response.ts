 ...
 */
export function instanceOfCreateSqlv1Statement201Response(value: object): value is CreateSqlv1Statement201Response {
    if (!('spec' in value) || value['spec'] === undefined) return false;
    if (!('status' in value) || value['status'] === undefined) return false;
    return true;
}

export function CreateSqlv1Statement201ResponseFromJSON(json: any): CreateSqlv1Statement201Response {
    return CreateSqlv1Statement201ResponseFromJSONTyped(json, false);
}

export function CreateSqlv1Statement201ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateSqlv1Statement201Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'metadata': json['metadata'] == null ? undefined : SqlV1StatementMetadataFromJSON(json['metadata']),
...
export function CreateSqlv1Statement201ResponseToJSONTyped(value?: Omit<CreateSqlv1Statement201Response, 'api_version'|'kind'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
