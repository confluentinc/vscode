...
export function SqlV1ConnectionListFromJSONTyped(json: any, ignoreDiscriminator: boolean): SqlV1ConnectionList {
    if (json == null) {
        return json;
    }
    return {
...
export function SqlV1ConnectionListToJSONTyped(value?: SqlV1ConnectionList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
