...
export function SqlV1StatementFromJSONTyped(json: any, ignoreDiscriminator: boolean): SqlV1Statement {
    if (json == null) {
        return json;
    }
    return {
...
export function SqlV1StatementToJSONTyped(value?: Omit<SqlV1Statement, 'api_version'|'kind'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
