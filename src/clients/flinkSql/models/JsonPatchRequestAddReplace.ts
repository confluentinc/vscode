 ...
 */
export function instanceOfJsonPatchRequestAddReplace(value: object): value is JsonPatchRequestAddReplace {
...
export function JsonPatchRequestAddReplaceFromJSONTyped(json: any, ignoreDiscriminator: boolean): JsonPatchRequestAddReplace {
    if (json == null) {
        return json;
    }
    return {
...
export function JsonPatchRequestAddReplaceToJSONTyped(value?: JsonPatchRequestAddReplace | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
