...
export function BrokerTaskTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrokerTaskType {
...
export function BrokerTaskTypeToJSONTyped(value: any, ignoreDiscriminator: boolean): BrokerTaskType {
