...
export function MirrorTopicStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): MirrorTopicStatus {
...
export function MirrorTopicStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): MirrorTopicStatus {
