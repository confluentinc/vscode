 ...
 */
export function instanceOfRemoveBrokerTaskDataList(
  value: object,
): value is RemoveBrokerTaskDataList {
...
export function RemoveBrokerTaskDataListFromJSONTyped(
  json: any,
...
export function RemoveBrokerTaskDataListToJSONTyped(
  value?: RemoveBrokerTaskDataList | null,
