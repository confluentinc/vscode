...
export function instanceOfCreateTopicRequestDataConfigsInner(
  value: object,
): value is CreateTopicRequestDataConfigsInner {
  if (!("name" in value) || value["name"] === undefined) return false;
  return true;
}

export function CreateTopicRequestDataConfigsInnerFromJSON(
  json: any,
): CreateTopicRequestDataConfigsInner {
  return CreateTopicRequestDataConfigsInnerFromJSONTyped(json, false);
}

export function CreateTopicRequestDataConfigsInnerFromJSONTyped(
  json: any,
