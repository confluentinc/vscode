...
export class SessionApi extends runtime.BaseAPI {
     ...
     */
    async sessionRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
     ...
     * Initialize interactive session
     */
    async session(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.sessionRaw(initOverrides);
    }
