...
export class TaskApi extends runtime.BaseAPI {
     ...
     * Inspect a task
     */
    async taskInspectRaw(requestParameters: TaskInspectRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Task>> {
     ...
     * Inspect a task
     */
    async taskInspect(requestParameters: TaskInspectRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Task> {
     ...
     * List tasks
     */
    async taskListRaw(requestParameters: TaskListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Task>>> {
        const queryParameters: any = {};
     ...
     * List tasks
     */
    async taskList(requestParameters: TaskListRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Task>> {
     ...
     * Get task logs
     */
    async taskLogsRaw(requestParameters: TaskLogsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Blob>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
        ...
        const response = await this.request({
            path: `/tasks/{id}/logs`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Get task logs
     */
    async taskLogs(requestParameters: TaskLogsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Blob> {
