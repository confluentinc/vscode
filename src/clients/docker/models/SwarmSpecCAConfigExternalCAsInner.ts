 ...
 */
export function instanceOfSwarmSpecCAConfigExternalCAsInner(
  value: object,
): value is SwarmSpecCAConfigExternalCAsInner {
  return true;
}

export function SwarmSpecCAConfigExternalCAsInnerFromJSON(
  json: any,
): SwarmSpecCAConfigExternalCAsInner {
  return SwarmSpecCAConfigExternalCAsInnerFromJSONTyped(json, false);
}

export function SwarmSpecCAConfigExternalCAsInnerFromJSONTyped(
  json: any,
