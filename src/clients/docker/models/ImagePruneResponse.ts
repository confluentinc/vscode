...
export function ImagePruneResponseFromJSONTyped(
  json: any,
  ...
  return {
    ImagesDeleted:
      json["ImagesDeleted"] == null
        ? undefined
        : (json["ImagesDeleted"] as Array<any>).map(ImageDeleteResponseItemFromJSON),
  ...
  return {
    ImagesDeleted:
      value["ImagesDeleted"] == null
        ? undefined
        : (value["ImagesDeleted"] as Array<any>).map(ImageDeleteResponseItemToJSON),
