 ...
 */
export function instanceOfClusterVolumeSpecAccessModeAccessibilityRequirements(
  value: object,
): value is ClusterVolumeSpecAccessModeAccessibilityRequirements {
  return true;
}

export function ClusterVolumeSpecAccessModeAccessibilityRequirementsFromJSON(
  json: any,
...
export function ClusterVolumeSpecAccessModeAccessibilityRequirementsFromJSONTyped(
  json: any,
