...
export function RegistryServiceConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): RegistryServiceConfig {
    ...
    return {
        ...
        'AllowNondistributableArtifactsCIDRs': json['AllowNondistributableArtifactsCIDRs'] == null ? undefined : json['AllowNondistributableArtifactsCIDRs'],
        'AllowNondistributableArtifactsHostnames': json['AllowNondistributableArtifactsHostnames'] == null ? undefined : json['AllowNondistributableArtifactsHostnames'],
