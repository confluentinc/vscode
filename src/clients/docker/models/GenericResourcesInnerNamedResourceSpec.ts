 ...
 */
export function instanceOfGenericResourcesInnerNamedResourceSpec(
  value: object,
): value is GenericResourcesInnerNamedResourceSpec {
  return true;
}

export function GenericResourcesInnerNamedResourceSpecFromJSON(
  json: any,
): GenericResourcesInnerNamedResourceSpec {
  return GenericResourcesInnerNamedResourceSpecFromJSONTyped(json, false);
}

export function GenericResourcesInnerNamedResourceSpecFromJSONTyped(
  json: any,
