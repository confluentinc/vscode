...
export function ServiceEndpointFromJSONTyped(
  json: any,
  ...
  return {
    ...
    Ports:
      json["Ports"] == null
        ? undefined
        : (json["Ports"] as Array<any>).map(EndpointPortConfigFromJSON),
    VirtualIPs:
      json["VirtualIPs"] == null
        ? undefined
        : (json["VirtualIPs"] as Array<any>).map(ServiceEndpointVirtualIPsInnerFromJSON),
  };
}
...
export function ServiceEndpointToJSONTyped(
  ...
  return {
    ...
    Ports:
      value["Ports"] == null
        ? undefined
        : (value["Ports"] as Array<any>).map(EndpointPortConfigToJSON),
    VirtualIPs:
      value["VirtualIPs"] == null
        ? undefined
        : (value["VirtualIPs"] as Array<any>).map(ServiceEndpointVirtualIPsInnerToJSON),
  };
}
