...
export function ServiceSpecModeFromJSONTyped(
  json: any,
  ...
  return {
    Replicated:
      json["Replicated"] == null
        ? undefined
        : ServiceSpecModeReplicatedFromJSON(json["Replicated"]),
    Global: json["Global"] == null ? undefined : json["Global"],
    ReplicatedJob:
      json["ReplicatedJob"] == null
        ? undefined
        : ServiceSpecModeReplicatedJobFromJSON(json["ReplicatedJob"]),
