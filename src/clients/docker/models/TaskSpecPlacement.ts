...
export function TaskSpecPlacementFromJSONTyped(
  json: any,
  ...
  return {
    ...
    Preferences:
      json["Preferences"] == null
        ? undefined
        : (json["Preferences"] as Array<any>).map(TaskSpecPlacementPreferencesInnerFromJSON),
    MaxReplicas: json["MaxReplicas"] == null ? undefined : json["MaxReplicas"],
    Platforms:
      json["Platforms"] == null
        ? undefined
        : (json["Platforms"] as Array<any>).map(PlatformFromJSON),
  };
}
  ...
  return {
    ...
    Preferences:
      value["Preferences"] == null
        ? undefined
        : (value["Preferences"] as Array<any>).map(TaskSpecPlacementPreferencesInnerToJSON),
    MaxReplicas: value["MaxReplicas"],
    Platforms:
      value["Platforms"] == null
        ? undefined
        : (value["Platforms"] as Array<any>).map(PlatformToJSON),
  };
}
