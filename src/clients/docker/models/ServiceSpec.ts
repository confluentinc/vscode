...
export function ServiceSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServiceSpec {
  ...
  return {
    ...
    UpdateConfig:
      json["UpdateConfig"] == null
        ? undefined
        : ServiceSpecUpdateConfigFromJSON(json["UpdateConfig"]),
    RollbackConfig:
      json["RollbackConfig"] == null
        ? undefined
        : ServiceSpecRollbackConfigFromJSON(json["RollbackConfig"]),
    Networks:
      json["Networks"] == null
        ? undefined
        : (json["Networks"] as Array<any>).map(NetworkAttachmentConfigFromJSON),
    EndpointSpec:
      json["EndpointSpec"] == null ? undefined : EndpointSpecFromJSON(json["EndpointSpec"]),
  };
}
...
export function ServiceSpecToJSONTyped(
  value?: ServiceSpec | null,
