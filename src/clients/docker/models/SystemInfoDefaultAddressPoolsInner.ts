 ...
 */
export function instanceOfSystemInfoDefaultAddressPoolsInner(
  value: object,
): value is SystemInfoDefaultAddressPoolsInner {
  return true;
}

export function SystemInfoDefaultAddressPoolsInnerFromJSON(
  json: any,
): SystemInfoDefaultAddressPoolsInner {
  return SystemInfoDefaultAddressPoolsInnerFromJSONTyped(json, false);
}

export function SystemInfoDefaultAddressPoolsInnerFromJSONTyped(
  json: any,
