 ...
 */
export function instanceOfSwarmSpecTaskDefaultsLogDriver(
  value: object,
): value is SwarmSpecTaskDefaultsLogDriver {
  return true;
}
...
export function SwarmSpecTaskDefaultsLogDriverFromJSONTyped(
  json: any,
