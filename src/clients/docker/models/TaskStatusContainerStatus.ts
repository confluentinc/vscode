 ...
 */
export function instanceOfTaskStatusContainerStatus(value: object): value is TaskStatusContainerStatus {
    return true;
}
...
export function TaskStatusContainerStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): TaskStatusContainerStatus {
    if (json == null) {
        return json;
    }
    return {
...
export function TaskStatusContainerStatusToJSONTyped(value?: TaskStatusContainerStatus | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
