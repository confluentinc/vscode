 ...
 */
export function instanceOfTaskSpecNetworkAttachmentSpec(
  value: object,
): value is TaskSpecNetworkAttachmentSpec {
  return true;
}
...
export function TaskSpecNetworkAttachmentSpecFromJSONTyped(
  json: any,
