 ...
 */
export function instanceOfEngineDescriptionPluginsInner(
  value: object,
): value is EngineDescriptionPluginsInner {
  return true;
}
...
export function EngineDescriptionPluginsInnerFromJSONTyped(
  json: any,
