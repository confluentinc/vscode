 ...
 */
export function instanceOfTaskSpecContainerSpecPrivilegesCredentialSpec(
  value: object,
): value is TaskSpecContainerSpecPrivilegesCredentialSpec {
  return true;
}

export function TaskSpecContainerSpecPrivilegesCredentialSpecFromJSON(
  json: any,
...
export function TaskSpecContainerSpecPrivilegesCredentialSpecFromJSONTyped(
  json: any,
