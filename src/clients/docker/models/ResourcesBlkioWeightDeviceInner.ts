 ...
 */
export function instanceOfResourcesBlkioWeightDeviceInner(
  value: object,
): value is ResourcesBlkioWeightDeviceInner {
  return true;
}

export function ResourcesBlkioWeightDeviceInnerFromJSON(
  json: any,
): ResourcesBlkioWeightDeviceInner {
  return ResourcesBlkioWeightDeviceInnerFromJSONTyped(json, false);
}

export function ResourcesBlkioWeightDeviceInnerFromJSONTyped(
  json: any,
