...
export function NetworkingConfigFromJSONTyped(
  json: any,
  ...
  return {
    EndpointsConfig:
      json["EndpointsConfig"] == null
        ? undefined
        : mapValues(json["EndpointsConfig"], EndpointSettingsFromJSON),
  };
}
  ...
  return {
    EndpointsConfig:
      value["EndpointsConfig"] == null
        ? undefined
        : mapValues(value["EndpointsConfig"], EndpointSettingsToJSON),
  };
}
