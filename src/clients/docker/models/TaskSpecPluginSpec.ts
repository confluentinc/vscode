...
export function TaskSpecPluginSpecFromJSONTyped(
  json: any,
  ...
  return {
    ...
    PluginPrivilege:
      json["PluginPrivilege"] == null
        ? undefined
        : (json["PluginPrivilege"] as Array<any>).map(PluginPrivilegeFromJSON),
  };
}
  ...
  return {
    ...
    PluginPrivilege:
      value["PluginPrivilege"] == null
        ? undefined
        : (value["PluginPrivilege"] as Array<any>).map(PluginPrivilegeToJSON),
  };
}
