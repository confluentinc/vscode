 ...
 */
export function instanceOfClusterVolumeSpecAccessModeCapacityRange(
  value: object,
): value is ClusterVolumeSpecAccessModeCapacityRange {
  return true;
}

export function ClusterVolumeSpecAccessModeCapacityRangeFromJSON(
  json: any,
): ClusterVolumeSpecAccessModeCapacityRange {
  return ClusterVolumeSpecAccessModeCapacityRangeFromJSONTyped(json, false);
}

export function ClusterVolumeSpecAccessModeCapacityRangeFromJSONTyped(
  json: any,
