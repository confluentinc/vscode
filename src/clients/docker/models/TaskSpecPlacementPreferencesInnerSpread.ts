 ...
 */
export function instanceOfTaskSpecPlacementPreferencesInnerSpread(
  value: object,
): value is TaskSpecPlacementPreferencesInnerSpread {
  return true;
}

export function TaskSpecPlacementPreferencesInnerSpreadFromJSON(
  json: any,
): TaskSpecPlacementPreferencesInnerSpread {
  return TaskSpecPlacementPreferencesInnerSpreadFromJSONTyped(json, false);
}

export function TaskSpecPlacementPreferencesInnerSpreadFromJSONTyped(
  json: any,
