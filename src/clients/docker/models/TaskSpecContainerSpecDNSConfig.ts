 ...
 */
export function instanceOfTaskSpecContainerSpecDNSConfig(
  value: object,
): value is TaskSpecContainerSpecDNSConfig {
  return true;
}
...
export function TaskSpecContainerSpecDNSConfigFromJSONTyped(
  json: any,
