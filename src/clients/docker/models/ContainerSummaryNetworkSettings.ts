 ...
 */
export function instanceOfContainerSummaryNetworkSettings(
  value: object,
): value is ContainerSummaryNetworkSettings {
  return true;
}

export function ContainerSummaryNetworkSettingsFromJSON(
  json: any,
): ContainerSummaryNetworkSettings {
  return ContainerSummaryNetworkSettingsFromJSONTyped(json, false);
}

export function ContainerSummaryNetworkSettingsFromJSONTyped(
  json: any,
