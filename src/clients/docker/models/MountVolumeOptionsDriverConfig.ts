 ...
 */
export function instanceOfMountVolumeOptionsDriverConfig(
  value: object,
): value is MountVolumeOptionsDriverConfig {
  return true;
}
...
export function MountVolumeOptionsDriverConfigFromJSONTyped(
  json: any,
