 ...
 */
export function instanceOfGenericResourcesInnerDiscreteResourceSpec(
  value: object,
): value is GenericResourcesInnerDiscreteResourceSpec {
  return true;
}

export function GenericResourcesInnerDiscreteResourceSpecFromJSON(
  json: any,
): GenericResourcesInnerDiscreteResourceSpec {
  return GenericResourcesInnerDiscreteResourceSpecFromJSONTyped(json, false);
}

export function GenericResourcesInnerDiscreteResourceSpecFromJSONTyped(
  json: any,
