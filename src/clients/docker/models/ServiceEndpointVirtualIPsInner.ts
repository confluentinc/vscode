 ...
 */
export function instanceOfServiceEndpointVirtualIPsInner(
  value: object,
): value is ServiceEndpointVirtualIPsInner {
  return true;
}
...
export function ServiceEndpointVirtualIPsInnerFromJSONTyped(
  json: any,
