...
export function HealthFromJSONTyped(json: any, ignoreDiscriminator: boolean): Health {
  ...
  return {
    ...
    Log:
      json["Log"] == null ? undefined : (json["Log"] as Array<any>).map(HealthcheckResultFromJSON),
  };
}
...
export function HealthToJSONTyped(
  ...
  return {
    ...
    Log:
      value["Log"] == null ? undefined : (value["Log"] as Array<any>).map(HealthcheckResultToJSON),
  };
}
