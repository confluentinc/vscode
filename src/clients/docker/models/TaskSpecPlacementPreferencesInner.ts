 ...
 */
export function instanceOfTaskSpecPlacementPreferencesInner(
  value: object,
): value is TaskSpecPlacementPreferencesInner {
  return true;
}

export function TaskSpecPlacementPreferencesInnerFromJSON(
  json: any,
): TaskSpecPlacementPreferencesInner {
  return TaskSpecPlacementPreferencesInnerFromJSONTyped(json, false);
}

export function TaskSpecPlacementPreferencesInnerFromJSONTyped(
  json: any,
  ...
  return {
    Spread:
      json["Spread"] == null
        ? undefined
        : TaskSpecPlacementPreferencesInnerSpreadFromJSON(json["Spread"]),
  };
}
