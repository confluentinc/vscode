...
export function instanceOfTaskSpecContainerSpecSecretsInnerFile(
  value: object,
): value is TaskSpecContainerSpecSecretsInnerFile {
  return true;
}

export function TaskSpecContainerSpecSecretsInnerFileFromJSON(
  json: any,
): TaskSpecContainerSpecSecretsInnerFile {
  return TaskSpecContainerSpecSecretsInnerFileFromJSONTyped(json, false);
}

export function TaskSpecContainerSpecSecretsInnerFileFromJSONTyped(
  json: any,
