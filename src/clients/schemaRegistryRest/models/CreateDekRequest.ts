...
export type CreateDekRequestAlgorithmEnum = typeof CreateDekRequestAlgorithmEnum[keyof typeof CreateDekRequestAlgorithmEnum];
...
export function CreateDekRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateDekRequest {
    if (json == null) {
        return json;
    }
    return {
        ...
        'encryptedKeyMaterial': json['encryptedKeyMaterial'] == null ? undefined : json['encryptedKeyMaterial'],
