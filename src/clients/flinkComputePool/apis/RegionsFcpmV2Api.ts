...
export class RegionsFcpmV2Api extends runtime.BaseAPI {
     ...
     * List of Regions
     */
    async listFcpmV2RegionsRaw(requestParameters: ListFcpmV2RegionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FcpmV2RegionList>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => FcpmV2RegionListFromJSON(jsonValue));
    }
     ...
     * List of Regions
     */
    async listFcpmV2Regions(requestParameters: ListFcpmV2RegionsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<FcpmV2RegionList> {
