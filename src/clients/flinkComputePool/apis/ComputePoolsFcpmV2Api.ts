...
export class ComputePoolsFcpmV2Api extends runtime.BaseAPI {
     ...
     */
    async createFcpmV2ComputePoolRaw(requestParameters: CreateFcpmV2ComputePoolOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateFcpmV2ComputePool202Response>> {
        ...
        const response = await this.request({
            ...
            body: CreateFcpmV2ComputePoolRequestToJSON(requestParameters['CreateFcpmV2ComputePoolRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => CreateFcpmV2ComputePool202ResponseFromJSON(jsonValue));
    }
     ...
     * Create a Compute Pool
     */
    async createFcpmV2ComputePool(requestParameters: CreateFcpmV2ComputePoolOperationRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateFcpmV2ComputePool202Response> {
     ...
     */
    async deleteFcpmV2ComputePoolRaw(requestParameters: DeleteFcpmV2ComputePoolRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            path: `/fcpm/v2/compute-pools/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id']))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Delete a Compute Pool
     */
    async deleteFcpmV2ComputePool(requestParameters: DeleteFcpmV2ComputePoolRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
     ...
     * Read a Compute Pool
     */
    async getFcpmV2ComputePoolRaw(requestParameters: GetFcpmV2ComputePoolRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetFcpmV2ComputePool200Response>> {
        if (requestParameters['environment'] == null) {
            throw new runtime.RequiredError(
                'environment',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetFcpmV2ComputePool200ResponseFromJSON(jsonValue));
    }
     ...
     * Read a Compute Pool
     */
    async getFcpmV2ComputePool(requestParameters: GetFcpmV2ComputePoolRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetFcpmV2ComputePool200Response> {
     ...
     */
    async listFcpmV2ComputePoolsRaw(requestParameters: ListFcpmV2ComputePoolsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListFcpmV2ComputePools200Response>> {
        if (requestParameters['environment'] == null) {
            throw new runtime.RequiredError(
                'environment',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ListFcpmV2ComputePools200ResponseFromJSON(jsonValue));
    }
     ...
     * List of Compute Pools
     */
    async listFcpmV2ComputePools(requestParameters: ListFcpmV2ComputePoolsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListFcpmV2ComputePools200Response> {
     ...
     */
    async updateFcpmV2ComputePoolRaw(requestParameters: UpdateFcpmV2ComputePoolOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetFcpmV2ComputePool200Response>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: UpdateFcpmV2ComputePoolRequestToJSON(requestParameters['UpdateFcpmV2ComputePoolRequest']),
        }, initOverrides);
     ...
     * Update a Compute Pool
     */
    async updateFcpmV2ComputePool(requestParameters: UpdateFcpmV2ComputePoolOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetFcpmV2ComputePool200Response> {
