...
* @enum {string}
*/
export enum FcpmV2ComputePoolListApiVersionEnum {
    FcpmV2 = 'fcpm/v2'
}
/**
* @export
* @enum {string}
*/
export enum FcpmV2ComputePoolListKindEnum {
...
export function FcpmV2ComputePoolListFromJSONTyped(json: any, ignoreDiscriminator: boolean): FcpmV2ComputePoolList {
    if (json == null) {
        return json;
    }
    return {
...
export function FcpmV2ComputePoolListToJSONTyped(value?: Omit<FcpmV2ComputePoolList, 'api_version'|'kind'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
