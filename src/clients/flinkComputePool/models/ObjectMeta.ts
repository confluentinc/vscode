...
export function ObjectMetaToJSONTyped(value?: Omit<ObjectMeta, 'self'|'resource_name'|'created_at'|'updated_at'|'deleted_at'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
