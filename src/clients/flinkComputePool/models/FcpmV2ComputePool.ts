...
export function FcpmV2ComputePoolFromJSONTyped(json: any, ignoreDiscriminator: boolean): FcpmV2ComputePool {
    if (json == null) {
        return json;
    }
    return {
...
export function FcpmV2ComputePoolToJSONTyped(value?: Omit<FcpmV2ComputePool, 'api_version'|'kind'|'id'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
