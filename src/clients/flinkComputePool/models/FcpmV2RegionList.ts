...
export function FcpmV2RegionListFromJSONTyped(json: any, ignoreDiscriminator: boolean): FcpmV2RegionList {
    if (json == null) {
        return json;
    }
    return {
...
export function FcpmV2RegionListToJSONTyped(value?: Omit<FcpmV2RegionList, 'api_version'|'kind'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
