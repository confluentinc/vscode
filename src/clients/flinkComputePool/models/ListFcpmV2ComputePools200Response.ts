...
* @enum {string}
*/
export enum ListFcpmV2ComputePools200ResponseApiVersionEnum {
    FcpmV2 = 'fcpm/v2'
}
/**
* @export
* @enum {string}
*/
export enum ListFcpmV2ComputePools200ResponseKindEnum {
 ...
 */
export function instanceOfListFcpmV2ComputePools200Response(value: object): value is ListFcpmV2ComputePools200Response {
...
export function ListFcpmV2ComputePools200ResponseFromJSON(json: any): ListFcpmV2ComputePools200Response {
    return ListFcpmV2ComputePools200ResponseFromJSONTyped(json, false);
}

export function ListFcpmV2ComputePools200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListFcpmV2ComputePools200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ListFcpmV2ComputePools200ResponseToJSON(json: any): ListFcpmV2ComputePools200Response {
    return ListFcpmV2ComputePools200ResponseToJSONTyped(json, false);
}

export function ListFcpmV2ComputePools200ResponseToJSONTyped(value?: Omit<ListFcpmV2ComputePools200Response, 'api_version'|'kind'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
