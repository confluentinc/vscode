 ...
 */
export function instanceOfFcpmV2ComputePoolListDataInner(value: object): value is FcpmV2ComputePoolListDataInner {
...
export function FcpmV2ComputePoolListDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): FcpmV2ComputePoolListDataInner {
    if (json == null) {
        return json;
    }
    return {
...
export function FcpmV2ComputePoolListDataInnerToJSONTyped(value?: Omit<FcpmV2ComputePoolListDataInner, 'api_version'|'kind'|'id'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
