...
* @enum {string}
*/
export enum CreateFcpmV2ComputePool202ResponseApiVersionEnum {
    FcpmV2 = 'fcpm/v2'
}
/**
* @export
* @enum {string}
*/
export enum CreateFcpmV2ComputePool202ResponseKindEnum {
 ...
 */
export function instanceOfCreateFcpmV2ComputePool202Response(value: object): value is CreateFcpmV2ComputePool202Response {
    if (!('spec' in value) || value['spec'] === undefined) return false;
    if (!('status' in value) || value['status'] === undefined) return false;
    return true;
}

export function CreateFcpmV2ComputePool202ResponseFromJSON(json: any): CreateFcpmV2ComputePool202Response {
    return CreateFcpmV2ComputePool202ResponseFromJSONTyped(json, false);
}

export function CreateFcpmV2ComputePool202ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateFcpmV2ComputePool202Response {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateFcpmV2ComputePool202ResponseToJSON(json: any): CreateFcpmV2ComputePool202Response {
    return CreateFcpmV2ComputePool202ResponseToJSONTyped(json, false);
}

export function CreateFcpmV2ComputePool202ResponseToJSONTyped(value?: Omit<CreateFcpmV2ComputePool202Response, 'api_version'|'kind'|'id'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
