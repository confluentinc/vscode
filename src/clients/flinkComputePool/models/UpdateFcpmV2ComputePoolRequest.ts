...
* @enum {string}
*/
export enum UpdateFcpmV2ComputePoolRequestApiVersionEnum {
    FcpmV2 = 'fcpm/v2'
}
/**
* @export
* @enum {string}
*/
export enum UpdateFcpmV2ComputePoolRequestKindEnum {
 ...
 */
export function instanceOfUpdateFcpmV2ComputePoolRequest(value: object): value is UpdateFcpmV2ComputePoolRequest {
...
export function UpdateFcpmV2ComputePoolRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateFcpmV2ComputePoolRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateFcpmV2ComputePoolRequestToJSONTyped(value?: Omit<UpdateFcpmV2ComputePoolRequest, 'api_version'|'kind'|'id'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
