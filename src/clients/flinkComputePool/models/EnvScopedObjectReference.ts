...
export function EnvScopedObjectReferenceToJSONTyped(value?: Omit<EnvScopedObjectReference, 'related'|'resource_name'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
