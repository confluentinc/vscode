 ...
 */
export function instanceOfGetFcpmV2ComputePool200Response(value: object): value is GetFcpmV2ComputePool200Response {
...
export function GetFcpmV2ComputePool200ResponseFromJSON(json: any): GetFcpmV2ComputePool200Response {
    return GetFcpmV2ComputePool200ResponseFromJSONTyped(json, false);
}

export function GetFcpmV2ComputePool200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetFcpmV2ComputePool200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetFcpmV2ComputePool200ResponseToJSONTyped(value?: Omit<GetFcpmV2ComputePool200Response, 'api_version'|'kind'|'id'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
