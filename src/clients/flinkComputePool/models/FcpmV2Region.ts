...
* @enum {string}
*/
export enum FcpmV2RegionApiVersionEnum {
    FcpmV2 = 'fcpm/v2'
}
/**
* @export
* @enum {string}
*/
export enum FcpmV2RegionKindEnum {
    Region = 'Region'
}
...
export function FcpmV2RegionToJSONTyped(value?: Omit<FcpmV2Region, 'api_version'|'kind'|'id'|'display_name'|'cloud'|'region_name'|'http_endpoint'|'private_http_endpoint'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
