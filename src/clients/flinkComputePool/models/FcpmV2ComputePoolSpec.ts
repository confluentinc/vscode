...
export function FcpmV2ComputePoolSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): FcpmV2ComputePoolSpec {
    if (json == null) {
        return json;
    }
    return {
        ...
        'environment': json['environment'] == null ? undefined : GlobalObjectReferenceFromJSON(json['environment']),
        'network': json['network'] == null ? undefined : EnvScopedObjectReferenceFromJSON(json['network']),
    };
}
...
export function FcpmV2ComputePoolSpecToJSONTyped(value?: FcpmV2ComputePoolSpec | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
