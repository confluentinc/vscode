...
export class StreamManagementApi extends runtime.BaseAPI {
     ...
     * Build a new stream
     */
    async buildStreamRaw(requestParameters: BuildStreamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<StreamDetails>> {
     ...
     * Build a new stream
     */
    async buildStream(requestParameters: BuildStreamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<StreamDetails> {
     ...
     */
    async buildStreamWithIdRaw(requestParameters: BuildStreamWithIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<StreamDetails>> {
        ...
        const response = await this.request({
            path: `/v1/streams/{streamId}`.replace(`{${"streamId"}}`, encodeURIComponent(String(requestParameters['streamId']))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: DatasetDTOToJSON(requestParameters['DatasetDTO']),
     ...
     * Build a stream with specific ID
     */
    async buildStreamWithId(requestParameters: BuildStreamWithIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<StreamDetails> {
     ...
     */
    async getDatasetStreamRaw(requestParameters: GetDatasetStreamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['streamId'] == null) {
            throw new runtime.RequiredError(
                'streamId',
     ...
     * Subscribe to stream events
     */
    async getDatasetStream(requestParameters: GetDatasetStreamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
     ...
     * Start a stream
     */
    async startDatasetStreamRaw(requestParameters: StartDatasetStreamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<StreamDetails>> {
        if (requestParameters['streamId'] == null) {
            throw new runtime.RequiredError(
                'streamId',
        ...
        const response = await this.request({
            path: `/v1/streams/{streamId}/start`.replace(`{${"streamId"}}`, encodeURIComponent(String(requestParameters['streamId']))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Start a stream
     */
    async startDatasetStream(requestParameters: StartDatasetStreamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<StreamDetails> {
