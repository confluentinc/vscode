...
export class SchemaManagementApi extends runtime.BaseAPI {
     ...
     */
    async convertAvroSchemaToDatasetRaw(requestParameters: ConvertAvroSchemaToDatasetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DatasetDTO>> {
     ...
     * Convert Avro schema to dataset
     */
    async convertAvroSchemaToDataset(requestParameters: ConvertAvroSchemaToDatasetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DatasetDTO> {
     ...
     */
    async getAvroSchemaRaw(requestParameters: GetAvroSchemaRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AvroSchemaResponseList>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => AvroSchemaResponseListFromJSON(jsonValue));
    }
     ...
     * Get Avro schemas for a Dataset
     */
    async getAvroSchema(requestParameters: GetAvroSchemaRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AvroSchemaResponseList> {
     ...
     */
    async getAvroSchemasForStreamRaw(requestParameters: GetAvroSchemasForStreamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AvroSchemaResponseList>> {
        ...
        const response = await this.request({
            path: `/v1/schemas/avro/stream/{streamId}`.replace(`{${"streamId"}}`, encodeURIComponent(String(requestParameters['streamId']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Get Avro schemas for existing stream
     */
    async getAvroSchemasForStream(requestParameters: GetAvroSchemasForStreamRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AvroSchemaResponseList> {
