...
export class BatchManagementApi extends runtime.BaseAPI {
     ...
     */
    async generateEventMessageBatchRaw(requestParameters: GenerateEventMessageBatchRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EventMessageList>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => EventMessageListFromJSON(jsonValue));
    }
     ...
     * Generate batch events
     */
    async generateEventMessageBatch(requestParameters: GenerateEventMessageBatchRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EventMessageList> {
     ...
     * Simulate stream
     */
    async streamSimulationRaw(requestParameters: StreamSimulationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EventStreamSimulationList>> {
        if (requestParameters['DatasetDTO'] == null) {
            throw new runtime.RequiredError(
                'DatasetDTO',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => EventStreamSimulationListFromJSON(jsonValue));
    }
     ...
     * Simulate stream
     */
    async streamSimulation(requestParameters: StreamSimulationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EventStreamSimulationList> {
