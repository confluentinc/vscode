...
export function EventMessageListFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventMessageList {
    if (json == null) {
        return json;
    }
    return {
...
export function EventMessageListToJSONTyped(value?: EventMessageList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
