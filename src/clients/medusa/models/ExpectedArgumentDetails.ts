...
export function ExpectedArgumentDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExpectedArgumentDetails {
    if (json == null) {
        return json;
    }
    return {
...
export function ExpectedArgumentDetailsToJSONTyped(value?: ExpectedArgumentDetails | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
