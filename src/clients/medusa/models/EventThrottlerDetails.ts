...
export function EventThrottlerDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventThrottlerDetails {
    if (json == null) {
        return json;
    }
    return {
        ...
        'arguments': json['arguments'] == null ? undefined : ((json['arguments'] as Array<any>).map(ExpectedArgumentDetailsFromJSON)),
    };
}
...
export function EventThrottlerDetailsToJSONTyped(value?: EventThrottlerDetails | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'arguments': value['arguments'] == null ? undefined : ((value['arguments'] as Array<any>).map(ExpectedArgumentDetailsToJSON)),
    };
}
