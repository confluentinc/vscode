...
export function ValueGeneratorDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ValueGeneratorDetails {
    if (json == null) {
        return json;
    }
    return {
...
export function ValueGeneratorDetailsToJSONTyped(value?: ValueGeneratorDetails | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
