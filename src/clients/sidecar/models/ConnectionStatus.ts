...
export function ConnectionStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectionStatus {
    ...
    return {
        ...
        'kafka_cluster': json['kafka_cluster'] == null ? undefined : KafkaClusterStatusFromJSON(json['kafka_cluster']),
        'schema_registry': json['schema_registry'] == null ? undefined : SchemaRegistryStatusFromJSON(json['schema_registry']),
    };
}
