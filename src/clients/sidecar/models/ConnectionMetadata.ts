...
export function ConnectionMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectionMetadata {
    if (json == null) {
        return json;
    }
    return {
...
export function ConnectionMetadataToJSONTyped(value?: ConnectionMetadata | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
