...
export function ProduceRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProduceRequest {
    if (json == null) {
        return json;
    }
    return {
        ...
        'headers': json['headers'] == null ? undefined : ((json['headers'] as Array<any>).map(ProduceRequestHeaderFromJSON)),
...
export function ProduceRequestToJSONTyped(value?: ProduceRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'headers': value['headers'] == null ? undefined : ((value['headers'] as Array<any>).map(ProduceRequestHeaderToJSON)),
