 ...
 *
 * The version of the OpenAPI document: 0.215.0
...
export function ConnectionSpecFromJSONTyped(
  ...
  return {
    ...
    ccloud_config: json["ccloud_config"] == null ? undefined : json["ccloud_config"],
    local_config: json["local_config"] == null ? undefined : json["local_config"],
    kafka_cluster: json["kafka_cluster"] == null ? undefined : json["kafka_cluster"],
    schema_registry: json["schema_registry"] == null ? undefined : json["schema_registry"],
  };
}
...
export function ConnectionSpecToJSONTyped(
  ...
  return {
    ...
    ccloud_config: value["ccloud_config"],
    local_config: value["local_config"],
    kafka_cluster: value["kafka_cluster"],
