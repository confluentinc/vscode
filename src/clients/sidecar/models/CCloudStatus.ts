...
export function CCloudStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): CCloudStatus {
    ...
    return {
        ...
        'requires_authentication_at': json['requires_authentication_at'] == null ? undefined : (new Date(json['requires_authentication_at'])),
...
export function CCloudStatusToJSONTyped(value?: CCloudStatus | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'requires_authentication_at': value['requires_authentication_at'] == null ? undefined : ((value['requires_authentication_at']).toISOString()),
