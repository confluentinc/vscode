...
export function ExceededFieldsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExceededFields {
    if (json == null) {
        return json;
    }
    return {
...
export function ExceededFieldsToJSONTyped(value?: ExceededFields | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
