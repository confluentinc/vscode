 ...
 */
export function instanceOfSimpleConsumeMultiPartitionRequest(value: object): value is SimpleConsumeMultiPartitionRequest {
    return true;
}

export function SimpleConsumeMultiPartitionRequestFromJSON(json: any): SimpleConsumeMultiPartitionRequest {
    return SimpleConsumeMultiPartitionRequestFromJSONTyped(json, false);
}

export function SimpleConsumeMultiPartitionRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SimpleConsumeMultiPartitionRequest {
    if (json == null) {
        return json;
    }
    return {
        
        'offsets': json['offsets'] == null ? undefined : ((json['offsets'] as Array<any>).map(PartitionOffsetFromJSON)),
...
export function SimpleConsumeMultiPartitionRequestToJSON(json: any): SimpleConsumeMultiPartitionRequest {
    return SimpleConsumeMultiPartitionRequestToJSONTyped(json, false);
}

export function SimpleConsumeMultiPartitionRequestToJSONTyped(value?: SimpleConsumeMultiPartitionRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'offsets': value['offsets'] == null ? undefined : ((value['offsets'] as Array<any>).map(PartitionOffsetToJSON)),
