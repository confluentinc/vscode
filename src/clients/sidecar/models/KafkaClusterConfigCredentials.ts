 ...
 * @export
 */
export type KafkaClusterConfigCredentials = ApiKeyAndSecret | BasicCredentials | KerberosCredentials | OAuthCredentials | ScramCredentials;
...
export function KafkaClusterConfigCredentialsFromJSONTyped(json: any, ignoreDiscriminator: boolean): KafkaClusterConfigCredentials {
    if (json == null) {
        return json;
    }
...
export function KafkaClusterConfigCredentialsToJSONTyped(value?: KafkaClusterConfigCredentials | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
