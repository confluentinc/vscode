...
export function RecordMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecordMetadata {
    if (json == null) {
        return json;
    }
    return {
        
        'key_metadata': json['key_metadata'] == null ? undefined : KeyOrValueMetadataFromJSON(json['key_metadata']),
        'value_metadata': json['value_metadata'] == null ? undefined : KeyOrValueMetadataFromJSON(json['value_metadata']),
    };
}
...
export function RecordMetadataToJSONTyped(value?: RecordMetadata | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
