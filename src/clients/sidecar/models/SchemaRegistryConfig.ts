...
export function SchemaRegistryConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): SchemaRegistryConfig {
    ...
    return {
        ...
        'uri': json['uri'],
        'credentials': json['credentials'] == null ? undefined : SchemaRegistryConfigCredentialsFromJSON(json['credentials']),
...
export function SchemaRegistryConfigToJSONTyped(value?: SchemaRegistryConfig | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
