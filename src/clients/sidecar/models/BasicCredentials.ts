...
export function BasicCredentialsFromJSONTyped(json: any, ignoreDiscriminator: boolean): BasicCredentials {
    if (json == null) {
        return json;
    }
    return {
...
export function BasicCredentialsToJSONTyped(value?: BasicCredentials | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
