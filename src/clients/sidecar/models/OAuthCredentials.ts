...
export function OAuthCredentialsFromJSONTyped(json: any, ignoreDiscriminator: boolean): OAuthCredentials {
    if (json == null) {
        return json;
    }
    return {
        ...
        'connect_timeout_millis': json['connect_timeout_millis'] == null ? undefined : json['connect_timeout_millis'],
        'ccloud_logical_cluster_id': json['ccloud_logical_cluster_id'] == null ? undefined : json['ccloud_logical_cluster_id'],
        'ccloud_identity_pool_id': json['ccloud_identity_pool_id'] == null ? undefined : json['ccloud_identity_pool_id'],
    };
}
...
export function OAuthCredentialsToJSONTyped(value?: OAuthCredentials | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
