...
export function KafkaClusterStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): KafkaClusterStatus {
    if (json == null) {
        return json;
    }
    return {
...
export function KafkaClusterStatusToJSONTyped(value?: KafkaClusterStatus | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
