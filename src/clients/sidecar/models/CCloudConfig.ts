...
export function CCloudConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): CCloudConfig {
    ...
    return {
        ...
        'ide_auth_callback_uri': json['ide_auth_callback_uri'] == null ? undefined : json['ide_auth_callback_uri'],
    };
}
...
export function CCloudConfigToJSONTyped(value?: CCloudConfig | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
