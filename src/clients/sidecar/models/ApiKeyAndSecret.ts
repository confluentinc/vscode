...
export function ApiKeyAndSecretFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiKeyAndSecret {
    if (json == null) {
        return json;
    }
    return {
...
export function ApiKeyAndSecretToJSONTyped(value?: ApiKeyAndSecret | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
