...
export function ScramCredentialsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScramCredentials {
    if (json == null) {
        return json;
    }
    return {
...
export function ScramCredentialsToJSONTyped(value?: ScramCredentials | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
