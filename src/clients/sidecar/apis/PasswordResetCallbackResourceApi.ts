...
export class PasswordResetCallbackResourceApi extends runtime.BaseAPI {
     ...
     */
    async rootGetRaw(requestParameters: RootGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
     ...
     * Password Reset Callback
     */
    async rootGet(requestParameters: RootGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
