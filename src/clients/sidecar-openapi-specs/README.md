...
| [flink-workspaces.openapi.yaml](./flink-workspaces.openapi.yaml) | [remove_flink_workspaces_contact.patch](./patches/remove_flink_workspaces_contact.patch) | Remove contact information from Flink Workspaces spec |
