 ...
 */
export function instanceOfPresignedUploadUrlArtifactV1PresignedUrlRequest(value: object): value is PresignedUploadUrlArtifactV1PresignedUrlRequest {
...
export function PresignedUploadUrlArtifactV1PresignedUrlRequestFromJSON(json: any): PresignedUploadUrlArtifactV1PresignedUrlRequest {
    return PresignedUploadUrlArtifactV1PresignedUrlRequestFromJSONTyped(json, false);
}

export function PresignedUploadUrlArtifactV1PresignedUrlRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PresignedUploadUrlArtifactV1PresignedUrlRequest {
    if (json == null) {
        return json;
    }
    return {
        ...
        'metadata': json['metadata'] == null ? undefined : ArtifactV1PresignedUrlRequestMetadataFromJSON(json['metadata']),
...
export function PresignedUploadUrlArtifactV1PresignedUrlRequestToJSON(json: any): PresignedUploadUrlArtifactV1PresignedUrlRequest {
    return PresignedUploadUrlArtifactV1PresignedUrlRequestToJSONTyped(json, false);
}

export function PresignedUploadUrlArtifactV1PresignedUrlRequestToJSONTyped(value?: Omit<PresignedUploadUrlArtifactV1PresignedUrlRequest, 'api_version'|'kind'|'id'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
