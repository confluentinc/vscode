 ...
 */
export function instanceOfGetArtifactV1FlinkArtifact200Response(value: object): value is GetArtifactV1FlinkArtifact200Response {
...
export function GetArtifactV1FlinkArtifact200ResponseFromJSON(json: any): GetArtifactV1FlinkArtifact200Response {
    return GetArtifactV1FlinkArtifact200ResponseFromJSONTyped(json, false);
}

export function GetArtifactV1FlinkArtifact200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetArtifactV1FlinkArtifact200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetArtifactV1FlinkArtifact200ResponseToJSON(json: any): GetArtifactV1FlinkArtifact200Response {
    return GetArtifactV1FlinkArtifact200ResponseToJSONTyped(json, false);
}

export function GetArtifactV1FlinkArtifact200ResponseToJSONTyped(value?: Omit<GetArtifactV1FlinkArtifact200Response, 'api_version'|'kind'|'id'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
