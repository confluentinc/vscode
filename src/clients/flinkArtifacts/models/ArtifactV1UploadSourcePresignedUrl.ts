 ...
 */
export function instanceOfArtifactV1UploadSourcePresignedUrl(value: object): value is ArtifactV1UploadSourcePresignedUrl {
    return true;
}

export function ArtifactV1UploadSourcePresignedUrlFromJSON(json: any): ArtifactV1UploadSourcePresignedUrl {
    return ArtifactV1UploadSourcePresignedUrlFromJSONTyped(json, false);
}

export function ArtifactV1UploadSourcePresignedUrlFromJSONTyped(json: any, ignoreDiscriminator: boolean): ArtifactV1UploadSourcePresignedUrl {
    if (json == null) {
        return json;
    }
    return {
        ...
        'metadata': json['metadata'] == null ? undefined : ArtifactV1UploadSourcePresignedUrlMetadataFromJSON(json['metadata']),
        'location': json['location'] == null ? undefined : json['location'],
        'upload_id': json['upload_id'] == null ? undefined : json['upload_id'],
    };
}

export function ArtifactV1UploadSourcePresignedUrlToJSON(json: any): ArtifactV1UploadSourcePresignedUrl {
    return ArtifactV1UploadSourcePresignedUrlToJSONTyped(json, false);
}

export function ArtifactV1UploadSourcePresignedUrlToJSONTyped(value?: Omit<ArtifactV1UploadSourcePresignedUrl, 'api_version'|'kind'|'id'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
