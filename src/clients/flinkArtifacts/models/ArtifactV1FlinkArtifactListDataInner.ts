 ...
 */
export function instanceOfArtifactV1FlinkArtifactListDataInner(value: object): value is ArtifactV1FlinkArtifactListDataInner {
...
export function ArtifactV1FlinkArtifactListDataInnerFromJSON(json: any): ArtifactV1FlinkArtifactListDataInner {
    return ArtifactV1FlinkArtifactListDataInnerFromJSONTyped(json, false);
}

export function ArtifactV1FlinkArtifactListDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ArtifactV1FlinkArtifactListDataInner {
    if (json == null) {
        return json;
    }
    return {
...
export function ArtifactV1FlinkArtifactListDataInnerToJSON(json: any): ArtifactV1FlinkArtifactListDataInner {
    return ArtifactV1FlinkArtifactListDataInnerToJSONTyped(json, false);
}

export function ArtifactV1FlinkArtifactListDataInnerToJSONTyped(value?: Omit<ArtifactV1FlinkArtifactListDataInner, 'api_version'|'kind'|'id'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
