 ...
 */
export function instanceOfArtifactV1PresignedUrlRequest(value: object): value is ArtifactV1PresignedUrlRequest {
    return true;
}
...
export function ArtifactV1PresignedUrlRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ArtifactV1PresignedUrlRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function ArtifactV1PresignedUrlRequestToJSONTyped(value?: Omit<ArtifactV1PresignedUrlRequest, 'api_version'|'kind'|'id'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
