 ...
 */
export function instanceOfCreateArtifactV1FlinkArtifact201Response(value: object): value is CreateArtifactV1FlinkArtifact201Response {
...
export function CreateArtifactV1FlinkArtifact201ResponseFromJSON(json: any): CreateArtifactV1FlinkArtifact201Response {
    return CreateArtifactV1FlinkArtifact201ResponseFromJSONTyped(json, false);
}

export function CreateArtifactV1FlinkArtifact201ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateArtifactV1FlinkArtifact201Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'metadata': json['metadata'] == null ? undefined : ArtifactV1FlinkArtifactMetadataFromJSON(json['metadata']),
        'cloud': json['cloud'],
        'region': json['region'],
        ...
        'versions': json['versions'] == null ? undefined : ((json['versions'] as Array<any>).map(ArtifactV1FlinkArtifactVersionFromJSON)),
    };
}

export function CreateArtifactV1FlinkArtifact201ResponseToJSON(json: any): CreateArtifactV1FlinkArtifact201Response {
    return CreateArtifactV1FlinkArtifact201ResponseToJSONTyped(json, false);
}

export function CreateArtifactV1FlinkArtifact201ResponseToJSONTyped(value?: Omit<CreateArtifactV1FlinkArtifact201Response, 'api_version'|'kind'|'id'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'versions': value['versions'] == null ? undefined : ((value['versions'] as Array<any>).map(ArtifactV1FlinkArtifactVersionToJSON)),
    };
}
