 ...
 */
export function instanceOfArtifactV1FlinkArtifactList(value: object): value is ArtifactV1FlinkArtifactList {
...
export function ArtifactV1FlinkArtifactListFromJSONTyped(json: any, ignoreDiscriminator: boolean): ArtifactV1FlinkArtifactList {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': (json['data'] == null ? null : new Set((json['data'] as Array<any>).map(ArtifactV1FlinkArtifactListDataInnerFromJSON))),
    };
}
...
export function ArtifactV1FlinkArtifactListToJSONTyped(value?: Omit<ArtifactV1FlinkArtifactList, 'api_version'|'kind'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': (value['data'] == null ? null : Array.from(value['data'] as Set<any>).map(ArtifactV1FlinkArtifactListDataInnerToJSON)),
    };
}
