...
* @enum {string}
*/
export enum ArtifactV1PresignedUrlApiVersionEnum {
...
* @enum {string}
*/
export enum ArtifactV1PresignedUrlKindEnum {
...
export function ArtifactV1PresignedUrlFromJSONTyped(json: any, ignoreDiscriminator: boolean): ArtifactV1PresignedUrl {
    if (json == null) {
        return json;
    }
    return {
...
export function ArtifactV1PresignedUrlToJSONTyped(value?: Omit<ArtifactV1PresignedUrl, 'api_version'|'kind'|'content_format'|'cloud'|'region'|'environment'|'upload_id'|'upload_url'|'upload_form_data'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
