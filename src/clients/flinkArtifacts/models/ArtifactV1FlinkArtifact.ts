...
export function ArtifactV1FlinkArtifactFromJSONTyped(json: any, ignoreDiscriminator: boolean): ArtifactV1FlinkArtifact {
    if (json == null) {
        return json;
    }
    return {
...
export function ArtifactV1FlinkArtifactToJSONTyped(value?: Omit<ArtifactV1FlinkArtifact, 'api_version'|'kind'|'id'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
