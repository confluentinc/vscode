...
export class FlinkArtifactsArtifactV1Api extends runtime.BaseAPI {
     ...
     */
    async createArtifactV1FlinkArtifactRaw(requestParameters: CreateArtifactV1FlinkArtifactOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateArtifactV1FlinkArtifact201Response>> {
        ...
        if (this.configuration && this.configuration.accessToken) {
            // oauth required
            headerParameters["Authorization"] = await this.configuration.accessToken("confluent-sts-access-token", []);
        }
        ...
        const response = await this.request({
            ...
            body: CreateArtifactV1FlinkArtifactRequestToJSON(requestParameters['CreateArtifactV1FlinkArtifactRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => CreateArtifactV1FlinkArtifact201ResponseFromJSON(jsonValue));
    }
     ...
     * Create a new Flink Artifact.
     */
    async createArtifactV1FlinkArtifact(requestParameters: CreateArtifactV1FlinkArtifactOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateArtifactV1FlinkArtifact201Response> {
     ...
     */
    async deleteArtifactV1FlinkArtifactRaw(requestParameters: DeleteArtifactV1FlinkArtifactRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['cloud'] == null) {
            throw new runtime.RequiredError(
                'cloud',
        ...
        const response = await this.request({
            path: `/artifact/v1/flink-artifacts/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id']))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Delete a Flink Artifact
     */
    async deleteArtifactV1FlinkArtifact(requestParameters: DeleteArtifactV1FlinkArtifactRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
     ...
     */
    async getArtifactV1FlinkArtifactRaw(requestParameters: GetArtifactV1FlinkArtifactRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetArtifactV1FlinkArtifact200Response>> {
        if (requestParameters['cloud'] == null) {
            throw new runtime.RequiredError(
                'cloud',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetArtifactV1FlinkArtifact200ResponseFromJSON(jsonValue));
    }
     ...
     * Read a Flink Artifact
     */
    async getArtifactV1FlinkArtifact(requestParameters: GetArtifactV1FlinkArtifactRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetArtifactV1FlinkArtifact200Response> {
     ...
     */
    async listArtifactV1FlinkArtifactsRaw(requestParameters: ListArtifactV1FlinkArtifactsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ArtifactV1FlinkArtifactList>> {
        if (requestParameters['cloud'] == null) {
            throw new runtime.RequiredError(
                'cloud',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ArtifactV1FlinkArtifactListFromJSON(jsonValue));
    }
     ...
     * List of Flink Artifacts
     */
    async listArtifactV1FlinkArtifacts(requestParameters: ListArtifactV1FlinkArtifactsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ArtifactV1FlinkArtifactList> {
     ...
     */
    async updateArtifactV1FlinkArtifactRaw(requestParameters: UpdateArtifactV1FlinkArtifactRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetArtifactV1FlinkArtifact200Response>> {
        if (requestParameters['cloud'] == null) {
            throw new runtime.RequiredError(
                'cloud',
     ...
     * Update a Flink Artifact
     */
    async updateArtifactV1FlinkArtifact(requestParameters: UpdateArtifactV1FlinkArtifactRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetArtifactV1FlinkArtifact200Response> {
